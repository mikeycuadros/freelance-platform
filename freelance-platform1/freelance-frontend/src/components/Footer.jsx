        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/how-it-works" className="text-gray-600 hover:text-purple-900">
                  Cómo Funciona
                </Link>
              </li>
              <li>
                <Link to="/explore" className="text-gray-600 hover:text-purple-900">
                  Encontrar Talento
                </Link>
              </li>
              <li>
                <Link to="/enterprise" className="text-gray-600 hover:text-purple-900">
                  Empresas
                </Link>
              </li>
              <li>
                <Link to="/success-stories" className="text-gray-600 hover:text-purple-900">
                  Casos de Éxito
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/find-work" className="text-gray-600 hover:text-purple-900">
                  Encontrar Trabajo
                </Link>
              </li>
              <li>
                <Link to="/community" className="text-gray-600 hover:text-purple-900">
                  Comunidad
                </Link>
              </li>
              <li>
                <Link to="/freelancer-stories" className="text-gray-600 hover:text-purple-900">
                  Historias de Freelancers
                </Link>
              </li>
              <li>
                <Link to="/tools" className="text-gray-600 hover:text-purple-900">
                  Herramientas
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/help-support" className="text-gray-600 hover:text-purple-900">
                  Ayuda y Soporte
                </Link>
              </li>
              <li>
                <Link to="/blog" className="text-gray-600 hover:text-purple-900">
                  Blog
                </Link>
              </li>
              <li>
                <Link to="/guides" className="text-gray-600 hover:text-purple-900">
                  Guías
                </Link>
              </li>
              <li>
                <Link to="/forum" className="text-gray-600 hover:text-purple-900">
                  Foro
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/about" className="text-gray-600 hover:text-purple-900">
                  Acerca de
                </Link>
              </li>
              <li>
                <Link to="/careers" className="text-gray-600 hover:text-purple-900">
                  Empleo
                </Link>
              </li>
              <li>
                <Link to="/press" className="text-gray-600 hover:text-purple-900">
                  Prensa
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-600 hover:text-purple-900">
                  Contacto
                </Link>
              </li>
            </ul>
